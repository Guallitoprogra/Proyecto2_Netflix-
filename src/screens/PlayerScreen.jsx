            ...
            <div className="player-controls">
              <button
                ...
                onClick={() =>
                  setIsPlaying((value) => {
                    ...
                    if (!nextValue) {
                      persistPlayback();
                      app.notify("Reproducción pausada y avance guardado");
                    } else {
                      app.notify("Reproducción reanudada");
                    }
              ...
              <button
                ...
                onClick={() => {
                  ...
                  app.notify(nextAudio ? "Audio activado" : "Audio silenciado");
                }}
              ...
              <button
                ...
                onClick={() => {
                  ...
                  app.notify(nextSubtitles ? "Subtítulos activados" : "Subtítulos desactivados");
                }}
                data-voice={
